...
AProjectile::AProjectile()
{
	...
	ProjectileParticleComponent = CreateDefaultSubobject<UParticleSystemComponent>(TEXT("Projectile Particle"));
	ProjectileParticleComponent->SetupAttachment(ProjectileMesh);
}
