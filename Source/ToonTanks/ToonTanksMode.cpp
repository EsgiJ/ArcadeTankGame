...
void AToonTanksMode::ActorDied(AActor* DeadActor)
{
    if (DeadActor == Tank)
    {
...
void AToonTanksMode::HandleGameStart()
{
...
int32 AToonTanksMode::GetTargetTowerCount()
{
